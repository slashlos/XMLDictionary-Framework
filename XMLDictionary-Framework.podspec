#
#  Be sure to run `pod spec lint XMLDictionary-Framework.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.name         = "XMLDictionary-Framework"
  spec.version      = "1.4.4"
  spec.summary      = "A class designed to simplify parsing and generating of XML on iOS and Mac OS."
...
Fork of Nick Lockwood's XMLDictionary 
  *  https://github.com/nicklockwood/XMLDictionary; see its Readme 
  *  https://github.com/danielctull-forks XMLDictionary wrapped
  ...
  spec.author             = { "cd santiago" => "slashlos@gmail.com" }
  # Or just: spec.author    = "cd santiago"
  # spec.authors            = { "cd santiago" => "slashlos@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/cd santiago"
  ...
  # spec.ios.deployment_target = "5.0"
    spec.osx.deployment_target = "15.7"
